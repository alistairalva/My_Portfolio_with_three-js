import { mobile, backend, creator, web, javascript, typescript, azure, linux, reactjs, java, tailwind, dotnet, nodejs, firebase, git, docker, redding_designs, goodLife, krachi_space, logo, emergencyapp, emergencyappMobile, restaurant, restaurantMobile, youtubecharts, youtubechartsMobile, csharp, } from "../assets";
...
const testimonials = [
    {
        testimonial: "I thought it was impossible to make a website as beautiful as our product, but Alistair proved me wrong.",
        name: "Sara Lee",
        designation: "CFO",
        company: "Acme Co",
    ...
    {
        testimonial: "I've never met a web developer who truly cares about their clients' success like Alistair does.",
        name: "Chris Brown",
        designation: "COO",
        company: "DEF Corp",
    ...
    {
        testimonial: "After Alistair optimized our website, our traffic increased by 50%. We can't thank them enough!",
        name: "Lisa Wang",
        designation: "CTO",
...
const projects = [
    {
        ...
        description: "A cross-platform mobile app to provide users with a reliable and efficient solution for sending emergency alerts to their selected contacts.",
        tags: [
            {
                name: "react-native",
    ...
    },
    {
        ...
        description: "Online platform to allow small restaurants, to build, launch and customize their website for free. Hosting is handled by us. Currently made private due to a security vulnerability.",
        tags: [
            {
                name: "ejs",
                color: "blue-text-gradient",
    ...
    },
    {
        ...
        description: "A set of interactive charts using d3,js to visualize raw youtube data. Data is loaded from a CSV file. Currently under revision.",
        tags: [
            {
                name: "vanillajs",
                color: "blue-text-gradient",
