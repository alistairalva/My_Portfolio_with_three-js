...
const routeMeta = {
    "/": {
        ...
        keywords: "technology consultant, software developer, backend engineer, cloud architecture, full stack developer, portfolio",
    },
    "/free-seo-audit": {
        ...
        keywords: "free seo audit, technical seo, seo consultant, site audit, search optimization, geo optimization",
    },
    "/thank-you": {
...
const RouteMetadata = () => {
    ...
    useEffect(() => {
        ...
        const robotsDirective = pathname === "/thank-you" ? "noindex, nofollow" : "index, follow";
        document.title = selectedMeta.title;
        upsertMetaTag('meta[name="description"]', "name", "description", selectedMeta.description);
        upsertMetaTag('meta[name="keywords"]', "name", "keywords", selectedMeta.keywords);
        upsertMetaTag('meta[name="author"]', "name", "author", "Alistair Alva");
        upsertMetaTag('meta[name="robots"]', "name", "robots", robotsDirective);
        upsertMetaTag('meta[name="googlebot"]', "name", "googlebot", robotsDirective);
        upsertMetaTag('meta[property="og:type"]', "property", "og:type", "website");
        upsertMetaTag('meta[property="og:site_name"]', "property", "og:site_name", "Alistair Alva Portfolio");
        upsertMetaTag('meta[property="og:title"]', "property", "og:title", selectedMeta.title);
        upsertMetaTag('meta[property="og:description"]', "property", "og:description", selectedMeta.description);
        upsertMetaTag('meta[property="og:url"]', "property", "og:url", canonicalUrl);
        upsertMetaTag('meta[property="og:image"]', "property", "og:image", `${baseUrl}${selectedMeta.socialImage}`);
        upsertMetaTag('meta[property="og:image:type"]', "property", "og:image:type", "image/svg+xml");
        ...
        upsertMetaTag('meta[property="og:image:alt"]', "property", "og:image:alt", selectedMeta.socialImageAlt);
        upsertMetaTag('meta[property="og:locale"]', "property", "og:locale", "en_US");
        upsertMetaTag('meta[name="twitter:card"]', "name", "twitter:card", "summary_large_image");
        upsertMetaTag('meta[name="twitter:title"]', "name", "twitter:title", selectedMeta.title);
        upsertMetaTag('meta[name="twitter:description"]', "name", "twitter:description", selectedMeta.description);
        upsertMetaTag('meta[name="twitter:image"]', "name", "twitter:image", `${baseUrl}${selectedMeta.socialImage}`);
        upsertMetaTag('meta[name="twitter:image:alt"]', "name", "twitter:image:alt", selectedMeta.socialImageAlt);
...
const App = () => {
    return (_jsxs(_Fragment, { children: [_jsx(Analytics, {}), _jsx(SpeedInsights, {}), _jsx(RouteMetadata, {}), _jsx("header", { children: _jsx(Navbar, {}) }), _jsx(Suspense, { fallback: _jsx("main", { id: "main-content", className: "relative z-0 bg-primary min-h-screen", "aria-busy": "true" }), children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(HomePage, {}) }), _jsx(Route, { path: "/free-seo-audit", element: _jsx(SeoAudit, {}) }), _jsx(Route, { path: "/thank-you", element: _jsx(ThankYou, {}) })] }) }), _jsx(ToastContainer, {})] }));
};
export default App;
